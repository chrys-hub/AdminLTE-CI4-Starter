...
<header>
	...
	<div class="menu">
		<ul>
			...
			<li class="menu-item hidden"><a href="/admin">Admin Panel</a></li>
		</ul>
	</div>
<center>
	<div class="heroe">
		...
		<h1>AdminLTE sudah di integrasi</h1>
		<h1>Klik Button Di bawah atau di bar atas untuk menuju admin panel</h1>
		<h1><span>&#8595;</span></h1>

		<li class="menu-item"><a href="/admin">Admin Panel</a></li>
